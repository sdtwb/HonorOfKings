...
//-------------------------------------------------------------------------主控制函数
	...
	public void battleMain() {
		...
		//--------------英雄初始
		person[0]= new PartPerson(100, 100, 100, 20, 50, '0');
		person[1]= new PartPerson(100, 100, 100, 2, 4, '1');
		person[2]= new PartPerson(100, 100, 100, 3, 4, '2');
		person[3]= new PartPerson(100, 100, 100, 1, 8, '3');
		person[4]= new PartPerson(100, 100, 100, 2, 8, '4');
		person[5]= new PartPerson(100, 100, 100, 32, 118, '5');
		person[6]= new PartPerson(100, 100, 100, 33, 118, '6');
		person[7]= new PartPerson(100, 100, 100, 34, 118, '7');
		person[8]= new PartPerson(100, 100, 100, 32, 115, '8');
		person[9]= new PartPerson(100, 100, 100, 33, 115, '9');
